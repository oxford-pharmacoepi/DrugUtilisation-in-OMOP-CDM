...
There are `r cdm$concept |> filter(concept_class_id == "Ingredient", standard_concept == "S") |> tally() |> pull() |> format(big.mark = ",")` standard ingredients in this version of vocabularies.
...
You can build the *Drug Era* using the [OmopConstructor](https://ohdsi.github.io/OmopConstructor/) R package.
